...
[![macOS](https://img.shields.io/badge/macOS-10.15.3-orange)](https://www.apple.com/macos/catalina/)
![Clover](https://img.shields.io/badge/Clover-5102-yellowgreen)
...
#### USB DisplayLink Dongle Display Output (NOT eGPU): 
   * [Plugable USB3-6950-HDMI](https://www.amazon.com/Plugable-Ethernet-Supports-Displays-3840x2160/dp/B075HMWLJF/ref=sr_1_fkmrnull_1?keywords=Plugable+USB3-6950-HDMI&qid=1555380658&s=gateway&sr=8-1-fkmrnull): This dongle is able to achieve 4K60P via USB3.0 and HDMI2.0 via the Display Chip. Note that other DisplayLink chips (DL-5000 and below) work as well, but if you are going for 4K you need to buy DL-6950 based dongle. The USB Type-C version works as well. [DisplayLink macOS Driver](https://www.displaylink.com/downloads/macos). However, it has its own limitations of [not being able to scale 4K into 1080P with 60FPS](http://assets.displaylink.com/live/downloads/release-notes/f1303_DisplayLink+USB+Graphics+Software+for+macOS+5.1-Release+Notes.txt). This is a known issue and we can only hope future update fix this. Here's a way to bypass that constrain and implement 4K60 with scaling. (Unconfirmed, this is from Thinkpad X1E) 
